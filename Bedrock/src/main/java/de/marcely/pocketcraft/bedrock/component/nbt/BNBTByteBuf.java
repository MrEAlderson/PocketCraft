...
public class BNBTByteBuf {
	
	private final ByteBuf buffer;
	private final ByteOrder order;
	private final boolean isNetwork;
	
	public BNBTByteBuf(ByteBuf buf, ByteOrder order, boolean isNetwork){
		this.buffer = buf;
		this.order = order;
		this.isNetwork = isNetwork;
	}
	
	public BNBTByteBuf(ByteOrder order, boolean isNetwork){
		this(Unpooled.buffer(), order, isNetwork);
	}
	
	public BNBTByteBuf(int initCapacity, ByteOrder order, boolean isNetwork){
		this(Unpooled.buffer(initCapacity), order, isNetwork);
	}
	
	public BNBTByteBuf(byte[] src, ByteOrder order, boolean isNetwork){
