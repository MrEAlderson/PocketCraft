...
public class BItemMapping {
	
	public static BItemMapping INSTANCE;
	...
	private static BItemMapping loadInternal() throws Exception {
		final BItemMapping instance = new BItemMapping();
