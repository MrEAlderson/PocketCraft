...
public class BSkinData {
	...
	public BSkinData(String skinId, byte[] skinData, byte[] capeData, String geometryName, byte[] geometryData){
		this.skinId = skinId;
	...
	public static BSkinData getDefaultSkin(){
		return new BSkinData(
				"Steve",
