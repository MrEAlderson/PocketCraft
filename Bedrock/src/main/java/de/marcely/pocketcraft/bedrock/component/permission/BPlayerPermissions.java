...
public class BPlayerPermissions {
	...
	@Getter @Setter private BCommandPermissionLevel commandLevel = BCommandPermissionLevel.NORMAL;
	@Getter @Setter private BPermissionLevel level = BPermissionLevel.VISITOR;
	...
	public static BPlayerPermissions newDefaultInstance(){
		final BPlayerPermissions permissions = new BPlayerPermissions();
